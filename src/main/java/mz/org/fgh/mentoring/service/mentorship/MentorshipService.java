...
public class MentorshipService {
    ...
    public List<Session> synchronizeMentorships(final List<Session> sessions) {
        for (final Session session : sessions) {
            Session se = this.sessionRepository.findByUuid(session.getUuid()).get();
            ...
            if(mentorshipDTO.getSession()!=null) {
                SessionDTO sessionDTO = mentorshipDTO.getSession();
                    ...
                    if (session == null) {
                        ...
                        List<Answer> answers = saveMentorshipAnswers(savedMentorship, mentorshipDTO.getAnswers(), user);
    ...
    private List<Answer> saveMentorshipAnswers(Mentorship mentorship, List<AnswerDTO> answerDTOS, User user) throws RuntimeException {
