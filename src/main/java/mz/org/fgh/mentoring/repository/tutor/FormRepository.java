...
public interface FormRepository extends CrudRepository<Form, Long> {
    ...
    @Query("select f FROM Form f INNER JOIN FETCH f.programmaticArea pa INNER JOIN FETCH f.formType  where pa.uuid in :programaticaAreaUuid")
    List<Form> findFormByProgrammaticAreaUuids(final List<String> programaticaAreaUuid);
